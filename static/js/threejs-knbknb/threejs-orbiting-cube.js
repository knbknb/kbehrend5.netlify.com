var demo = (function(){
    ...
    var scene=new THREE.Scene(),
        ...
        function initScene(){
            ...
            var div_scalingfactor = 3.0;
            renderer.setSize( window.innerWidth/div_scalingfactor, window.innerHeight/div_scalingfactor );
            ...
            camera = new THREE.PerspectiveCamera(
                    35,
                    (window.innerWidth / window.innerHeight)/div_scalingfactor,
                    1,
                    1000
                );
            ...
            //ground
            var texture = THREE.ImageUtils.loadTexture('/img/gallery/grasslight-big.jpg') //texture from three.js examples
        ...
        function setupGui(){
            ...
            //note we could link the various object properties directly to the gui
            //  but this would prevent us from being able to modify them e.g. radians to degrees
