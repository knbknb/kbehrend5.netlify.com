...
datadir <- here::here("data2/gfzock")
see_if(is.readable(datadir))

infile1 <- file.path(datadir, "EM2016_compiled_final.csv")
infile2 <- file.path(datadir, "real_games_scores_full.txt")
infile3 <- file.path(datadir, "gfzock_prize-money-winners.csv")
...
outfile <- file.path(datadir, "gfzock_euro2016_preprocessed.RData")
