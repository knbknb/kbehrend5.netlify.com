...
htmltools::HTML('<div class="alert alert-info"><b>Performing model selection techniques  on anonymized data from 10000 people representing the general US Population</b>. I am assuming Blood Pressure is a dependent variable. 
</div>')
...
We will use the package `glmnet`, which does not use the model formula language, so we will set up a matrix `x` of predictors and a response vector `y`.
...
- 0 : ridge
- 1 : lasso
- 0.x  : elasticnet (combination of ridge and lasso)
