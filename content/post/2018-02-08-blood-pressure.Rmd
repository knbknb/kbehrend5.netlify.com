...
The datasets were gathered independently. One of them is a tiny teaching dataset, the other is a larger medical study. Both datasets show that systolic blood pressure rises about 5-10 mm Hg per decade of a person &apos;s life. </div>')
```
...
htmltools::HTML(sprintf('<div class="alert alert-warning">So the rate is more like <b>%s mm Hg/year.</b> Half as much as for the toy dataset. For data from a group <i>similar to me</i>(men only, 45+ yrs, 70-80 kg) the rate is ~6 mmHg/decade, a bit higher than %s mmHg/decade. (See below)</div>', bpr,  round(10*bpr,1)))
