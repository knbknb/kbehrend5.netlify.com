...
My motivation in writing this up was (1) learning more *ggplot* tricks, and more importantly, (2) gaining insights from a real data that interests me. It was also a helpful exercise to start with a small teaching dataset, then switch to a messier, larger dataset: a real medical study with data from 10000 people.
...
Light blue line is the 1:1 line. 
