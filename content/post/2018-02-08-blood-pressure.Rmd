...
Also, for 45-year olds the average blood pressure is already well over 120. Some doctors consider this  unhealthy already.
...
```{r bpplot, fig.cap="Blood pressure as a function of age and body weight. NHANES data filtered to match my own age- BMI- and weight-range. Red dots are predicted values."}
