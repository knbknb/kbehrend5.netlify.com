...
```
I have included the interaction term `age:weight` because from experience it makes sense. The older body metabolizes slower, and at each age the human body has different rates of gaining weight.
