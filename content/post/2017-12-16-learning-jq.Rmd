...
htmltools::HTML('<div class="alert alert-info"><b></b> Some notes about learning jq, the  lightweight and flexible command-line JSON processor. I&apos;ll extend and improve this blog post in the next months, in Q1/2018. This page is a notepad for my own use, it has not the purpose to teach anyone.</div>')
```
