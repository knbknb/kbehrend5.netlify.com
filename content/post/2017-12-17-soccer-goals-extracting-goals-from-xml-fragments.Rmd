...
This is part 1 of a 2-part series about my first attempts at Bayesian Analysis of Soccer data. 

#### Dataset

The dataset used here is the "European Soccer database from Kaggle.com. This dataset is delivered as a Sqlite database. It contains 7 tables which have been filled by scraping mumerous websites many times in 2014-2016.
