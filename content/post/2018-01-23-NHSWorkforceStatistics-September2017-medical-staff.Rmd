...
Since 2014, the number of nurses indeed has decreased for most subtypes. Most notably "outgoing" groups of nurses show marked decline. The number of "adult nurses" has stayed rather constant. 
This loss in specialty nurses is compensated by an increase in &apos;allied health professions&apos;. See plots at bottom of page. 
</div>')
```
...
- add more observations from the plots
- add data from/for Germany for comparison (where to git?)
