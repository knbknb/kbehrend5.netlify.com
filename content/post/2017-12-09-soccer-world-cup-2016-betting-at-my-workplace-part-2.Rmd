...
Most accurately predicted 'tendencies'. The two rightmost columns indicate the number of people who got it right.
...
Least accurately predicted 'tendencies'. The two rightmost columns indicate the number of people who got it right.
...
```{r tend1, echo=FALSE, fig.width=8, results='hide'}
