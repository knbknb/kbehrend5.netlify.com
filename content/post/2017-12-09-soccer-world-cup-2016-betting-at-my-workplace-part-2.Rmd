...
In the next run of the betting game, I'll predict more draws, and also put my jokers on draws. Otherwise I won't make it into the ranks that win some of that prize money.