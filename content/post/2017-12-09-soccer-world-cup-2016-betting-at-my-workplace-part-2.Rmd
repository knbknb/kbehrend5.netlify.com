...
ggplot(corr_pred_by.2, aes(seq_along(game_nr),corr_pred_by)) +
        ...
        geom_point(data = surprise_results_tend, 
                   ...
                   size = 5, shape = 21) +
        xlab("Games ranked by prediction accuracy") +
        ylab("# of people who got tendency/abs.score right") +
        ggtitle(subt) +
...
```{r echo=FALSE}
kable(surprise_results_tend, col.names=c(nm, "Pos"))
```
