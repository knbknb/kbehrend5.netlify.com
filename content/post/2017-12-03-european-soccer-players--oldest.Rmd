...
We can use the `Player_in_match` table to find the oldest player who participated in any match. This corresponds to the leftmost bar in the histogram above. This bar corresponds to the matches of a single soccer player, born in 1970.
...
So the database says that Tugay Kerimoğlu has played for Everton, and did so until the 2011/2012 season (I've omitted a few of his "matches" in the table above). According to the [Wikipedia article about him](https://en.wikipedia.org/wiki/Tugay_Kerimo%C4%9Flu), this is clearly wrong. 
