...
I really like the Chaos Communication Congress. I remember well how I discovered it:
(TBC)

I'm not in the CCC. I like the live streams. Continued  education is important. High Quality content for free.
...
Using a series of shell commands and pipelines,
I tried my best to recover the first tweet from each line, discarding the fragmented JSON object of tweet 2. This recovery step might produce duplicated tweets for some reason. 
...
For the the 33C3 I've started gathering tweets later (on the 27th) and finished earlier.
The 34C3 congress had 15000 visitors, much more than 33C3 ([12000 participants](https://de.wikipedia.org/wiki/Chaos_Communication_Congress#Kongress-Mottos_und_Veranstaltungsorte_1984_bis_heute)), but absolute count of tweets per hour seems to be lower in 2017. 
...
This plot shows that there was some user activity on Twitter even before the 34c4 started, and after it ended.
