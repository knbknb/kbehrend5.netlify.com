...
This dataset contains data from two collection periods, 2009-2010 and 2011-2012. Some attributes wer collected during period 1, but not in period 2, or they were collected in different ways. Therefore the dataset contains many NULL values just because of this. Moreover many attributes, such as "head circumference", were only collected for babies and children.  
...
First, remove attributes that were collected for babies, children and generally people less than 20 years of age.
...
data_frame(`Column Name` = names(NHANES_mice$nmis),
        ...
        kable(row.names = 1, 
              caption = "Column names in NHANES data set,\
              after removal of redundant and inapplicable columns") %>% 
        kable_styling(bootstrap_options = 
                c("striped", "hover"))
```
